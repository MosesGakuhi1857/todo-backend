...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql+psycopg2://moringaaccess:12345678@localhost/todoo'
...
@app.route('/todo/<user_id>/user', methods=['GET'])
...
@app.route('/todo', methods=['POST'])  # create a todo
def create_todo():
...
# update a todo
@app.route('/todo/<todo_id>/update', methods=['PUT'])
